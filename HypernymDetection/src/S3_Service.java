...
public class S3_Service {
    ...
    private final String bucketName = "yourfriendlyneighborhoodbucketman1";
    ...
    public File downloadFromS3(String nameInS3, String nameInSystem){
        if(!objectExists(nameInS3))
            return null;
        ...
        try{
            BufferedOutputStream outputStream = new BufferedOutputStream(new FileOutputStream(nameInSystem));
            ...
            System.err.println("ERROR: FileOutputStream:" + e.getMessage());
            System.exit(1);
        }
        catch (IOException e) {
        ...
        return new File(nameInSystem);
    }

    public void getAllObjects(){
        ListObjectsResponse x = s3Client.listObjects(ListObjectsRequest.builder().bucket(bucketName).build());
        List<S3Object> y = x.contents();
        for (S3Object a: y) {
            System.out.println("getAllObjects: " + a.key());
        }
    }
